...
},{"./vue.runtime.common.dev.js":31,"./vue.runtime.common.prod.js":33,"_process":28}],33:[function(require,module,exports){
(function (global,setImmediate){
/*!
 * Vue.js v2.6.11
 * (c) 2014-2019 Evan You
...
},{"timers":29}],34:[function(require,module,exports){
var Vue = require('vue');
...
},{"../../vue/index.vue":37,"vue":32}],35:[function(require,module,exports){
var $ = window.$ = window.jQuery = require('jquery');

require('./app/app.js');

console.log('Hello Gulp and Node.js !!!');
},{"./app/app.js":34,"jquery":27}],36:[function(require,module,exports){
;(function(){
//
//
//
...
var weatherForDay = require('axios');
var forecast = require('axios');
var now = new Date();
   ...
   module.exports = {
       ...
       methods: {
           getNow: function() {
               var today = new Date();
               var currentMinutes = (today.getMinutes().toString().length > 1) ? today.getMinutes() : '0' + today.getMinutes();
               var currentHours = (today.getHours().toString().length > 1) ? today.getHours() : '0' + today.getHours();
               var currentMonth = ((today.getMonth()+1).toString().length > 1) ? today.getMonth() : '0' + (today.getMonth()+1);
               var currentDay = (today.getDate().toString().length > 1) ? today.getDate() : '0' + today.getDate();
               var time = currentHours + ":" + currentMinutes;
               var date = currentDay+'-'+(currentMonth)+'-'+today.getFullYear();
               var dataTime = time;
               var dateDate = date;


               this.timestamp = dataTime;
               this.datestamp = dateDate;             
           }
       ...
       mounted: function () {
           weatherForDay
               .get('https://api.openweathermap.org/data/2.5/weather?q=London,uk&APPID=f7272b7ffb31673dc34ab41b1f3db4a1&lang=en&units=metric')
               .then(function (responce) {
               console.log(responce.data);
               
               this.today=responce.data;
               this.iconcode=responce.data.weather[0].icon;
              
               }.bind(this));
               
           forecast
               .get('https://api.openweathermap.org/data/2.5/forecast?q=London,uk&APPID=f7272b7ffb31673dc34ab41b1f3db4a1&lang=en&units=metric')
               .then(function (responce) {
               console.log(responce);

               this.nextdays=responce.data.list.slice(1, 6);
               console.log(days);
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"weather-wrap"},[_c('div',{staticClass:"time"},[_c('div',{staticClass:"time-date"},[_c('div',{staticClass:"clock"},[_vm._v(_vm._s(_vm.timestamp))]),_vm._v(" "),_c('div',{staticClass:"date"},[_vm._v(_vm._s(_vm.datestamp))])]),_vm._v(" "),_c('div',{staticClass:"city"},[_vm._v(_vm._s(_vm.today.name)+","+_vm._s(_vm.today.sys.country))])]),_vm._v(" "),_c('div',{staticClass:"weather"},[_c('div',{staticClass:"today"},[_c('div',{staticClass:"mainweather"},[_c('img',{staticClass:"icons",attrs:{"src":'https://openweathermap.org/img/w/' + _vm.iconcode + '.png'}}),_vm._v("\n                "+_vm._s(_vm.today.weather[0].description))]),_vm._v(" "),_c('div',{staticClass:"maintemp"},[_vm._v(_vm._s(Math.round(_vm.today.main.temp)))])]),_vm._v(" "),_c('div',{staticClass:"forecast"},_vm._l((_vm.nextdays),function(nextday,index){return _c('div',{key:index,staticClass:"day"},[_c('span',{staticClass:"temperature"},[_vm._v(_vm._s(Math.round(nextday.main.temp)))]),_vm._v(" "),_c('span',{staticClass:"weath"},[_vm._v(_vm._s(nextday.weather[0].description))]),_vm._v(" "),_c('span',{staticClass:"next-date"},[_vm._v(_vm._s(nextday.dt_txt))])])}),0)])])}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4455d2f4", __vue__options__)
  } else {
    hotAPI.reload("data-v-4455d2f4", __vue__options__)
  }
})()}
},{"axios":1,"vue":32,"vue-hot-reload-api":30}],37:[function(require,module,exports){
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"global-container"},[_c('weather')],1)}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-eb0da508", __vue__options__)
  } else {
    hotAPI.rerender("data-v-eb0da508", __vue__options__)
  }
})()}
},{"./components/weather.vue":36,"vue":32,"vue-hot-reload-api":30}]},{},[35]);
